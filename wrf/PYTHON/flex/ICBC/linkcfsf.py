...
parser.add_argument('-i', dest='datadir', type=str, default='/raid1/static/CFSF/data', 
                    help = 'CFSF data directory')
parser.add_argument('-o', dest='locdir', type=str, default='/raid1/static/CFSR/data', 
        ...
        # f = x + cymd + '*.' + enmem + '.' + inidate + '.grb2'
          ...
          for eachf in glob.glob(os.path.join(FDIR,x,f)):
              ...
              #  datapath = os.path.join(locdir,year,month)
                 ...
                 print 'sof-link... ', eachf, newf 

                 os.system("rm -f %s"%newf)

                 os.symlink(eachf, newf)
