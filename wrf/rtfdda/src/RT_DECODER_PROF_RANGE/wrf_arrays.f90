...
!!!
  subroutine get_iarray3d(ncid,varid,array_name,array)
...
!!!
  subroutine get_iarray2d(ncid,varid,array_name,array)
...
!!!
  subroutine get_iarray1d(ncid,varid,array_name,array)
...
!!!
  subroutine get_iarray0d(ncid,varid,array_name,array)
...
! print*,'array(1,1) = ',array(1,1)
  ...
  end subroutine get_iarray0d
!!!
  subroutine get_darray0d(ncid,varid,array_name,array)
