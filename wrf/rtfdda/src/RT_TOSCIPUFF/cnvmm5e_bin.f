...
c==============================================================================
      ...
      subroutine wrtmedoc_bin(ni,nj,nk,iyear,imon,iday,ihour,imin,isec,
...
c
      write(nf) 'BBBBBBBB'
      write(nf) blank
      write(nf) iday,imon,iyear,ihour,imin,isec
      write(nf) iday,imon,iyear,ihour,imin,isec
      write(nf) numi,numj,nk,0,4,num2d
      write(nf) blank
      write(nf) blank
      write(nf) ztrans,dlon,dlat,x0n,y0n,xlat0n,xlon0n,
     :              0.,0.,0.,0.,ztrans(nk)
      write(nf) name3d,namdum,namdum,namdum,namdum,
     :               name2d,namdum,namdum,namdum
      write(nf) u
      write(nf) v
      write(nf) w
      write(nf) th
