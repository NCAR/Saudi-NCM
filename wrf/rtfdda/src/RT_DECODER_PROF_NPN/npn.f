...
C     Begin variable loop
 ...
 4006  format(1x,' variable number ',i5,' dummy= ',a20, 'nvdim=',I3)
       ...
       print *, "J=",J,"vdim=",vdim1,vdim2,vdim3,vdim4
       enddo
c      stop
               ...
               do k1=1,vdim1
                  do k2=1,1
                    do k3=1,1
                     ...
                     start(2) = k2
                     start(3) = k3
                     call ncvgt1 (ncid, i,start,levels(k3,k1,k2),rcode)
                    enddo
                  enddo
               enddo
               ...
               do k1=1,vdim1
                  do k2=1,vdim2
                    do k3=1,1
                     ...
                     start(2) = k2
                     start(3) = k3
                     call ncvgt1 (ncid, i,start,u_wind(k3,k1,k2),rcode)
                    enddo
                  enddo
               enddo
               ...
               do k1=1,vdim1
                  do k2=1,vdim2
                    do k3=1,1
                     ...
                     start(2) = k2
                     start(3) = k3
                     call ncvgt1 (ncid, i,start,v_wind(k3,k1,k2),rcode)
                    enddo
                  enddo
               enddo
               ...
               do k1=1,vdim1
                  do k2=1,vdim2
                    do k3=1,1
                     ...
                     start(2) = k2
                     start(3) = k3
                 call ncvgt1 (ncid, i,start,u_wind_qc(k3,k1,k2),rcode)
               ...
               do k1=1,vdim1
                  do k2=1,vdim2
                    do k3=1,1
                     ...
                     start(2) = k2
                     start(3) = k3
                     call ncvgt1 (ncid, i,start,w_wind(k3,k1,k2),rcode)
                    enddo
                  enddo
               enddo
...
c------------   one profiler by one                ------------
     ...
     &  levels(im,il,1).ge.0..and.levels(im,il,1).lt.18000.
     &  ) then 
         ht(no)=xlev+levels(im,il,1)
         ht_qc(no)=0.
       endif
...
c
     ...
     &          td(nobst), td_qc(nobst), ww(nobst), ww_qc(nobst)
      ...
      nobsn=0
      do n=1,nobst
      if((ht(n).gt.0..and.ht(n).lt.18000.) .and. (
