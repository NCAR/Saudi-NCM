...
c
      write(iup,*)'Welcome to your friendly RIP (V4.6) output file !'   ! March 2010
c     call flush(iup)
      igotit_sl=0
c
...
c
     ...
     &      rtjen,cdiff,rdiff,ldfrl,xtime,tacch,ccalb,
...
c            if (storm_val(1,1,k) .gt. 0.) then
  ...
  976        format(9f10.3)
     ...
     &         rstmv,lgrad,llapl,lhadv,rcrag,rcrbg,rslcg,ismth,
     &         ismcp,toptextclg,ilev,ixavg,icomg,csout,idimn,raddf,
     &         rtjst,rtjen,rtjti,titlestr,cdiff,rdiff,
