...
c
     ...
     &   iexpandedout,iskpd1
c
      print*,'Welcome to your friendly RIPDP (V4.6) output file !'     ! March 2010
...
c        Rong's fix
         print*,'Use MODIS 20-category land use data set and continue.'
         ilandset=3
c        print*,'MMINLU=',nf_att_text(1:5)
c        STOP
c        End Rong's fix
      endif
c
