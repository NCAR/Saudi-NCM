...
begin
  ...
  res@tiMainString = "1 Hour Precipitation (mm)"
...
if(  $#argv == 1 ) then
    setenv ncl_exe PlotRain_1hr.ncl
else
    setenv ncl_exe PlotRain_st4_1hr.ncl
    setenv DATE $2
endif
