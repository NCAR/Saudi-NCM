...
foreach f ( eta.T${time_to_access}Z.AWIP3D00.tm00 \
            ...
            eta.T${time_to_access}Z.AWIP3D63.tm00 \
            eta.T${time_to_access}Z.AWIP3D66.tm00 \
            eta.T${time_to_access}Z.AWIP3D69.tm00 \
            eta.T${time_to_access}Z.AWIP3D72.tm00 )
...
echo "${SUBSYSTEM}  Using for pregrid: ${PREGRID_EXE}"
...
( time ./regridder.exe ) >> print.out_${eta_date}
