...
set PREGRID_VTABLE_NNRP_ALL = $CONSTANT_FILES/PREGRID_VTABLE.NNRP2
...
set DECODING_AVN_DIR  = ${RUNDIR}/${cycle_date}/NNRP2_REGRID
...
if (-d $GEAPSTMP) then
  ...
  if (! -e $DECODING_AVN_DIR) ln -s $GEAPSTMP/NNRP2_REGRID $DECODING_AVN_DIR
else
