...
$sysdeps = {
    ...
    'pdq-conf'   => '/usr/lib64/pdq',
    'pdq-printrc' => '/usr/lib64/pdq/printrc',
    'pdq-foomatic' => '/usr/lib64/pdq/drivers/foomatic',
    'pdq-print'  => '/usr/bin/pdq',
    'pdq-jobdir' => '~/.printjobs',
    'ppr-pprd' => '/usr/lib64/ppr/bin/pprd',
    'ppr-interfaces' => '/usr/lib64/ppr/interfaces',
