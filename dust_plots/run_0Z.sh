...
#Add our local colormap to the path
export NCARG_COLORMAPS=/lustre/project/k1206/x_fisherh/dust_plots:$NCARG_ROOT/lib/ncarg/colormaps
/usr/bin/perl /lustre/project/k1206/x_fisherh/dust_plots/plot_DUST_all_d100Z.pl
/usr/bin/perl /lustre/project/k1206/x_fisherh/dust_plots/plot_DUST_all_d200Z.pl
